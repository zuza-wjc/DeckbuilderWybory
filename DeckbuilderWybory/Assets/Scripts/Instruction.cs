    ...
    public void ChangeInstruction(int pageCount)
    {
        switch (pageCount)
        {
            ...
            case 13:
                ...
                return;
            case 14:
                instructionText.text="Na koniec gry wygrywa osoba z największym poparciem. W wypadku remisu sprawdzana jest liczba regionów a w następnej kolejności wartość budżetu. ";
                ...
                return;
            case 15:
                instructionText.text="Jeśli chcesz zmodyfikować swoją talię, wejdź w TWOJE TALIE w MENU. W talii musisz mieć 10 kart Podstawowych i 15 kart Specjalnych wybranego typu. Miłej gry!";
